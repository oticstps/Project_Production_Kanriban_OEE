...
const Manhour = () => {
  ...
  const calculateTotals = useCallback(() => {
    const stopData = filteredData.filter(item => item.status === 'STOP');
    ...
    const totalManhourPerPcs = totalActualProduksi > 0 ? totalSigmaManhour / totalActualProduksi : 0;
  ...
  const exportToExcel = useCallback(async () => {
    try {
      ...
      // Sesuaikan header dengan urutan yang diminta
      const headers = [
        'TGL',
        'Shift',
        'Σ produksi',
        ...
        'kaizen',
        '5s',
        'rincian manhour inline',
        'bantuan',
        '5s',
        'total manhour',
        'manour(man.menit/pcs)',
        'PE',
        'action'
      ];
      ...
      tanggalBulan.forEach(day => {
        ...
        ['Shift 1', 'Shift 2'].forEach(shiftName => {
          ...
          // Sesuaikan urutan data dengan header
          worksheet.addRow([
            day,
            shiftName,
      ...
      worksheet.columns = [
        ...
        { width: 10 }, { width: 15 }, { width: 10 }, { width: 20 }, { width: 15 },
        { width: 10 }, { width: 15 }, { width: 20 }, { width: 10 }, { width: 15 }
      ];
  ...
  const handleOpenCreateModal = useCallback((defaultShift = '') => {
    setCurrentItem(null);
    setFormData(prev => ({
      ...prev,
      line_id: '',
    ...
    setIsModalOpen(true);
  }, [pg, lineName, nameProduct, tahun, bulan]);
  ...
  }, [data, getApiEndpoint, fetchAllDataFromAPIs]);
  ...
  }, [formData, currentItem, getApiEndpoint, fetchAllDataFromAPIs]);
  ...
  return (
    <Layout>
      <div className="p-2">
        ...
        {/* Tabel dengan fixed layout sesuai header yang diminta */}
        <div className="bg-white rounded-lg shadow overflow-auto max-h-[65vh]">
          <div className="min-w-[2000px]">
            <table className="w-full divide-y divide-gray-200 table-fixed">
              <thead className="bg-gray-50 sticky top-0 z-10">
                <tr>
                  <th className="w-16 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">TGL</th>
                  <th className="w-16 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">Shift</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">Σ produksi</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">Σ OP</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">Loading Time</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">Opr Bantuan</th>
                  <th className="w-28 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">loading time opr bantuan</th>
                  <th className="w-28 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">quality check</th>
                  ...
                  <th className="w-20 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">frekuensi</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">dangae</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">kaizen</th>
                  <th className="w-20 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">5s</th>
                  <th className="w-28 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">rincian manhour inline</th>
                  <th className="w-24 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">bantuan</th>
                  <th className="w-20 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">5s</th>
                  <th className="w-28 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">total manhour</th>
                  <th className="w-28 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">manour(man.menit/pcs)</th>
                  <th className="w-20 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">PE</th>
                  <th className="w-32 px-1.5 py-1.5 text-xs font-medium text-gray-900 uppercase tracking-wider border text-center">action</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  return (
                    <React.Fragment key={dateKey}>
                      ...
                      <tr className={!shift1Data ? "bg-red-50" : ""}>
                        <td className="px-1.5 py-1.5 whitespace-nowrap text-xs font-medium text-gray-900 border text-center">
                          {day}
                        </td>
                ...
                <tr className="bg-blue-50 font-bold">
                  ...
                  <td className="px-1.5 py-1.5 whitespace-nowrap text-xs text-gray-800 border text-center" colSpan="11">
                    {/* Kosong untuk kolom 6 sampai 16 */}
                  </td>
                  <td className="px-1.5 py-1.5 whitespace-nowrap text-xs text-gray-800 border text-center">
