...
// ============== LAYER 2: Pemrosesan Transit -> Core (Disesuaikan) ==============
      ...
      if (row.status === 'START') {
        ...
        if (produced >= MIN_ACTUAL_PCS) {
          ...
          recordsToInsert.push({
            ...
            // Kolom tambahan diisi NULL jika tidak digunakan
            manpower_help: null,
            loading_time_manpower_help: null,
            machine_fault_preq: null,
            machine_fault_duration: null,
            quality_check: null,
            another: null,
            kaizen: null,
            five_s: null,
            manhour_in_line: null,
            manhour_helper: null,
            manhour_five_s: null,
            total_manhour: null,
            manhour_man_minutes_per_pcs: null,
            PE: null,
            bottle_neck_process: null,
            bottle_neck_process_duration: null,
            bottle_neck_mct: null,
            bottle_neck_mct_duration: null,
            setup_manpower: null,
            dangae: null,
            loading_time_start: null,
            loading_time_stop: null
          });
